...
@section('title', 'Pasangan Calon Baru - ')
@section('content') 
                        <div class="row page-title align-items-center">
                            <div class="col-sm-4 col-xl-6">
                                <h4 class="mb-1 mt-0">Pasangan Calon Baru</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <h4 class="header-title mt-0 mb-1">Tambah Pasangan Calon BEM</h4> 
                                   
<form method="POST" action="{{url('pengelola/calon-bem/new')}}" enctype="multipart/form-data">
    @csrf
    <div class="form-group row mt-4">
      <label class="col-md-2" >Nama Pasangan</label>
      <div class="col-md-6">
      <input type="text" class="form-control" name="calon_namapasangan"  required>
      </div>
    </div>
    <div class="form-group row mt-4">
      <label class="col-md-2" >Slogan Pasangan</label>
      <div class="col-md-6">
      <input type="text" class="form-control" name="calon_slogan"  required>
      </div>
    </div>
    <div class="form-group row mt-4">
...
<div class="col-md-6">
  ...
  <div class="form-group row mt-4">
    ...
    <div class="col-md-8">
    <input type="text" class="form-control" name="calon_npmketua"  required>
    </div>
  </div>
  <div class="form-group row mt-4">
    <label class="col-md-4" >Nama Ketua</label>
    <div class="col-md-8">
    <input type="text" class="form-control" name="calon_namaketua"  required>
    </div>
  </div> 
  <div class="form-group row mt-4">
...
<div class="col-md-6">
  ...
  <div class="form-group row mt-4">
    ...
    <div class="col-md-8">
    <input type="text" class="form-control" name="calon_npmwakil"  required>
    </div>
  </div>
  <div class="form-group row mt-4">
    <label class="col-md-4" >Nama Wakil Ketua</label>
    <div class="col-md-8">
    <input type="text" class="form-control" name="calon_namawakil"  required>
    </div>
  </div> 
  <div class="form-group row mt-4">
