...
@section('content') 
                        <div class="row page-title align-items-center">
                            <div class="col-sm-4 col-xl-6">
                                <h4 class="mb-1 mt-0">Pemilih Baru</h4>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="card">
                                    ...
                                    <h4 class="header-title mt-0 mb-1">Tambah Pemilih</h4> 
                                   
<form method="POST" action="{{url('pengelola/pemilih/new')}}">
    @csrf
    ...
    <div class="form-group row mt-4">
      ...
      <div class="col-md-3">
      <input type="text" class="form-control" name="pemilih_nama"  required autofocus>
      </div>
    </div>
    <div class="form-group row mt-4">
      <label class="col-md-2" >Email Student Unpad Pemilih</label>
      <div class="col-md-3">
      <input type="text" class="form-control" name="pemilih_email"  required autofocus>
      </div>
    </div>
    <div class="form-group row mt-4">
  ...
  <div class="form-group row mt-4">
    <div class="col-md-12">
<button class="btn btn-md btn-primary" type="submit">Tambah Pemilih</button>
    </div>
</div>
