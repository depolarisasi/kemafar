              ...
              <div class="row mt-3"> 
                ...
                <div class="card border">
                  ...
                  <div class="card-footer p-3">
                    <a href="#" class="btn btn-md btn-primary">Lihat Profil, Visi Misi & Program Kerja</a> 
                  </div>
                </div>
              </div>
                @endforeach
